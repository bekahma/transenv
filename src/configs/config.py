...
class GenerationConfig:
    ...
    openai_call_mode: str = field(default="sync", metadata={"help": "Hosted OpenAI calling mode: sync or batch"})
    openai_batch_poll_interval: int = field(default=60, metadata={"help": "Seconds between Batch API status checks"})
    openai_batch_output_dir: str = field(default=None, metadata={"help": "Directory for OpenAI Batch API request/result JSONL files"})
